...
<div ng-controller="AdminCtrl" class="ng-root">
    <div class='col-md-2'>
        <ul class='nav nav-pills nav-stacked admin-nav' role='tablist'>
            <li role='presentation' aria-controls="home" class='admin-nav-item active'><a href='#home'>主页</a></li>
            <li role='presentation' aria-controls="links" class='admin-nav-item'><a href='#links'>链接</a></li>
            <li role='presentation' aria-controls="settings" class='admin-nav-item'><a href='#settings'>设置</a></li>
    ...
    <div class='col-md-10'>
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                <h2>欢迎来到 {{env('APP_NAME')}} 的管理面板！</h2>
                <p>使用左手边的链接来切换 {{env('APP_NAME')}} 面板的导航项。</p>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="settings">
                ...
                <form action='/admin/action/change_password' method='POST'>
                    原密码: <input class="form-control password-box" type='password' name='current_password' />
                    新密码: <input class="form-control password-box" type='password' name='new_password' />
                    <input type="hidden" name='_token' value='{{csrf_token()}}' />
                    <input type='submit' class='btn btn-success change-password-btn' value='确认修改'/>
                </form>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="admin">
                ...
                <h3 class="users-heading">用户</h3>
                <a ng-click="state.showNewUserWell = !state.showNewUserWell" class="btn btn-primary btn-sm status-display">新用户</a>
            ...
            <div role="tabpanel" class="tab-pane" id="developer">
                ...
                <div class='row'>
                    ...
                    <div class='col-md-4'>
                        <a href='#' ng-click="generateNewAPIKey($event, '{{$user_id}}', true)" id='api-reset-key' class='btn btn-danger'>重置</a>
                    </div>
                </div>
